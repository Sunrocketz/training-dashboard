...
Операционный дашборд обучения: сводка по группам тренеров (воронка, отсев, конверсии) и оценка выпуска после линии — без выгрузки сырых ПДн учеников во внешний UI.
...
flowchart LR
  ...
  LineOS["Книга «Выход на линию — ОС»\nлист 2026"]
  GAS["Apps Script\napps-script/Код.js"]
...
- Книга «Выход на линию — ОС», лист `2026` — оценки супервайзеров после выхода (см. DataModel / ADR-015).
